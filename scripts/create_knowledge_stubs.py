...
STUBS: list[KnowledgeStub] = [
    ...
    k("divisors-and-multiples", "約数と倍数", "A問題相当", "その他数学系", absorbs=["倍数判定", "約数列挙", "約数の個数", "約数の総和", "最大公約数", "最小公倍数", "トーシェント関数"]),
    ...
    k("insertion-dp", "挿入DP", "F問題相当", "高速化系", aliases=["Insertion DP", "insertion DP"], related=["動的計画法"]),
    k("convex-hull", "凸包", "F問題相当", "幾何学系", aliases=["Convex Hull", "convex hull"], related=["偏角ソート"]),
